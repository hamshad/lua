...
--   FIXED_DT — fixed timestep (from utils)
--   frameAccumulator — carries leftover time to the next frame
...
-- Fixed timestep: accumulate real delta, then step the chapter a
-- whole number of fixed steps. Deterministic at any frame rate.
...
function drawControls()
    ...
    love.graphics.print("[1-9,0] Ch1-10  [-] Ch11  [=] Ch12  [13] Ch13  [14] Ch14  [SPACE] Reset  [ESC] Quit", 10, 752)    love.graphics.setColor(1, 1, 1)
end